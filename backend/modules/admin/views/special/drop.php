...
$this->title = 'Drop Table `Special Questions`';
...
<div class="answers-drop">
	...
	<div class="description">
		<h2>Attention:</h2>
		<p>This section of the website is used for deleting all the contents of the table 'Special Questions'.</p>
		<p>By clicking on the button "Drop Table", you hereby acknoledge the fact that all the special questions will be
